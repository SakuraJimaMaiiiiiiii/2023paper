...
for i=1:m
    flname=strcat('E:\files\tqwt_code_data\故障轴承数据\XJTU-SP\Data\XJTU-SY_Bearing_Datasets\35Hz12kN\Bearing1_2\\',num2str(i),'.csv');       %获得文件全地址
...
sig=data_ho(:);
sig1=sig';
figure,plot(sig1,'color',0.5*[1 1 1])
xlim([0,5000000])
xlabel('时间 '),ylabel('幅值')
...
figure,plot(rms_ho,'color',0.5*[1 1 1])
